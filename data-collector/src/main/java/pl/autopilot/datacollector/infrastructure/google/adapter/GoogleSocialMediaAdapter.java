package pl.autopilot.datacollector.infrastructure.google.adapter;
...
@Slf4j
@Component("googleSocialMediaAdapter")
@RequiredArgsConstructor
public class GoogleSocialMediaAdapter implements SocialMediaPort {

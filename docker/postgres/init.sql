...
GRANT ALL PRIVILEGES ON SCHEMA keycloak TO app;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA keycloak TO app;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA keycloak TO app;